  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img style="width: 100px" :src="detail.imgUrl" alt="" />
          </li>
          <li>
            <p>
              {{ detail.skuName }}
...
export default {
  ...
  computed: {
    ...
    selectAddress() {
      ...
      // 先判断是不是 userAddressList 是 就往下找 address.id 是否是 等于 被选中的状态selectAddressId 不是就返回一个空{}
